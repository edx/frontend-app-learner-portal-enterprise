...
export interface components {
  schemas: {
     ...
     * @enum {string}
     */
    ActionTypeF02Enum: "learner_linked" | "notified" | "reminded" | "redeemed" | "cancelled" | "cancelled_acknowledged" | "expired" | "expired_acknowledged" | "reversed" | "allocated" | "reallocated" | "approved" | "errored";
    ...
    LearnerContentAssignmentAction: {
       ...
       * * `errored` - Assignment encountered an error
       */
      action_type: components["schemas"]["ActionTypeF02Enum"];
      /**
       * Format: date-time
