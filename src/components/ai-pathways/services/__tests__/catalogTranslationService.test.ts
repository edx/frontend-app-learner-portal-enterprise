    ...
    exactSkillFilters: [
      {
        ...
        catalogField: 'skill_names', matchMethod: 'exact',
        tier: 'broad_anchor', score: 80, source: 'intent_required',
      },
      {
      ...
      },
      {
        ...
        catalogField: 'skill_names', matchMethod: 'exact',
        tier: 'narrow_signal', score: 40, source: 'intent_preferred',
      },
      {
        taxonomySkill: 'JSON', catalogSkill: 'JSON',
        catalogField: 'skill_names', matchMethod: 'exact',
        tier: 'narrow_signal', score: 35, source: 'career_taxonomy',
      },
    ],
    aliasSkillFilters: [],
    unmatched: [],
