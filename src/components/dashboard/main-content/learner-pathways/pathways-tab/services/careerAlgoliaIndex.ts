 ...
 * non-hook Algolia precedent in this repo (`courseAlgoliaIndex.ts`, this directory)
 * targets the course-catalog index, not jobs/taxonomy, so this is a narrow sibling for
 * that index.
 */
