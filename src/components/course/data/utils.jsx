 ...
 * known end (i.e., it is after the run's start date). Some course runs (e.g., self-paced) may
 * carry a placeholder end date far in the future; callers should not display such a value.
 *
 * @param {Object} args
 * @param {Object} args.courseRun
 *
